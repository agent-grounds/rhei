...
include!("cli/accounting_profile_prices.rs");
include!("cli/accounting_schemas.rs");
include!("cli/accounting_records.rs");
include!("cli/accounting_pricing.rs");
...
include!("cli/snapshot_runtime_continue.rs");
...
include!("cli/session_report_prompt.rs");
include!("cli/session_report_render.rs");
include!("cli/session_report_metrics.rs");
...
mod tests {
    ...
    include!("cli/tests_migrate_export_priors.rs");
