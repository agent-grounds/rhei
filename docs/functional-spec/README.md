...
| [§FS-rhei-budgets](rhei-budgets.spec.md#fs-rhei-budgets-bounded-ticket-travel-and-project-invocations) | Bounded ticket travel and project invocations: resolution, the machine ceiling, the account, and the halt |
